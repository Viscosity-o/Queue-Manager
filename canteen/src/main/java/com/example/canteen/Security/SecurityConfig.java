...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Read origins from cors.allowed-origins property (configurable via CORS_ALLOWED_ORIGINS env var)
    ...
    // Standalone CorsFilter bean — runs BEFORE Spring Security, handles preflight immediately
    @Bean
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/Canteen/**", "/staff/**").hasRole("CANTEEN")
